package com.szu.audio_play.impl;
...
public class AudioPlayService implements IAudioPlayService {
    ...
    @Override
    public void initPlayer(String filePath, int playerType, int sampleRateInHz, int channelConfig, int audioEncoding, int playMode, int streamType, boolean isLooping) {
        mPath = filePath;
